...
_RECONFIGREQUEST = _descriptor.Descriptor(
  name='ReconfigRequest',
  full_name='tensorflow.ReconfigRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='config', full_name='tensorflow.ReconfigRequest.config', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RECONFIGRESPONSE = _descriptor.Descriptor(
  name='ReconfigResponse',
  full_name='tensorflow.ReconfigResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_RECONFIGREQUEST.fields_by_name['config'].message_type = tensorflow_dot_core_dot_protobuf_dot_config__pb2._CONFIGPROTO
...
DESCRIPTOR.message_types_by_name['ReconfigRequest'] = _RECONFIGREQUEST
DESCRIPTOR.message_types_by_name['ReconfigResponse'] = _RECONFIGRESPONSE
...
ReconfigRequest = _reflection.GeneratedProtocolMessageType('ReconfigRequest', (_message.Message,), dict(
  DESCRIPTOR = _RECONFIGREQUEST,
  __module__ = 'tensorflow.core.protobuf.master_pb2'
  # @@protoc_insertion_point(class_scope:tensorflow.ReconfigRequest)
  ))
_sym_db.RegisterMessage(ReconfigRequest)

ReconfigResponse = _reflection.GeneratedProtocolMessageType('ReconfigResponse', (_message.Message,), dict(
  DESCRIPTOR = _RECONFIGRESPONSE,
  __module__ = 'tensorflow.core.protobuf.master_pb2'
  # @@protoc_insertion_point(class_scope:tensorflow.ReconfigResponse)
  ))
_sym_db.RegisterMessage(ReconfigResponse)
