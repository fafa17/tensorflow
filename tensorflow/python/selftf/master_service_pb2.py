...
_MASTERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Reconfig',
    full_name='tensorflow.grpc.MasterService.Reconfig',
    index=7,
    containing_service=None,
    input_type=tensorflow_dot_core_dot_protobuf_dot_master__pb2._RECONFIGREQUEST,
    output_type=tensorflow_dot_core_dot_protobuf_dot_master__pb2._RECONFIGRESPONSE,
    options=None,
  ),
])
